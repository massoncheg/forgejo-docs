...
- **Stable** (latest release): receives full support, bugfixes and security fixes for three months, plus a two week window after the next stable release is made available.
